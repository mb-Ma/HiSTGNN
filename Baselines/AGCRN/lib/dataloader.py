...
from model.meteo4agrcn import load_dataset
...
def get_dataloader(args, normalizer = 'std', tod=False, dow=False, weather=False, single=True):
    ...
    data, scaler = load_dataset(data_path, name=args.dataset)
    ...
    ##############get dataloader######################
    train_dataloader = data_loader(data['x_train'], data['y_train'], args.batch_size, shuffle=True, drop_last=True)
    val_dataloader = data_loader(data['x_val'], data['y_val'], args.batch_size, shuffle=False, drop_last=True)
    test_dataloader = data_loader(data['x_test'], data['y_test'], args.batch_size, shuffle=False, drop_last=False)
